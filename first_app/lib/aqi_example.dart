...
const String token = "659ccf300781867a4238c5bdb41daf72b5a89ec1";
  ...
  Map<String, dynamic> aqiStyle(int? aqi) {
    ...
    if (aqi <= 100)
      return {
        ...
        "emoji": "😊",
        "label": "Moderate",
        "gradient": [Colors.lightBlue.shade400, Colors.lightBlue.shade100],
      };
    if (aqi <= 150)
      return {
        ...
        "emoji": "😷",
        "label": "Unhealthy SG",
        "gradient": [Colors.deepOrange.shade400, Colors.deepOrange.shade200],
      };
    if (aqi <= 200)
      return {
        "color": Colors.pink,
        "emoji": "🤒",
        "label": "Unhealthy",
        "gradient": [Colors.pink.shade400, Colors.pink.shade200],
      };
    if (aqi <= 300)
      return {
        "color": Colors.purple,
    ...
    return {
      ...
      "emoji": "☠️",
      "label": "Hazardous",
      "gradient": [Colors.indigo.shade800, Colors.indigo.shade400],
    };
  }
